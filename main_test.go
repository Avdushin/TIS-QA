...
func TestSolveQE(t *testing.T) {
	...
	for _, tt := range testCases {
		...
		t.Logf("Тестовый случай: a=%v, b=%v, c=%v", tt.a, tt.b, tt.c)
		t.Logf("Входные данные: a=%v, b=%v, c=%v", tt.a, tt.b, tt.c)
		t.Logf("Ожидаемый корень 1: %v, Ожидаемый корень 2: %v, Ожидаемый D: %v, Ожидаемое наличие корней: %v",
			tt.expectedRoot1, tt.expectedRoot2, tt.expectedD, tt.expectedHasRoot)
